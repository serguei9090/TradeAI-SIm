...
- [x] TODO(lint_fix_001): Fix 64 critical lint errors in frontend.
- [x] TODO(coverage_001): Raise test coverage for App.tsx to >= 80%.
- TODO(dry_001): Resolve DRY violations between backend_routes.ts and tradingEngine.ts.
